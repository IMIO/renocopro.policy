...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.is_product_installed("renocopro.policy"))
    ...
    def test_browserlayer(self):
        ...
        self.assertIn(IRenocoproPolicyLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.is_product_installed("renocopro.policy"))
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(IRenocoproPolicyLayer, utils.registered_layers())
